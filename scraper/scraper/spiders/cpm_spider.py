...
class CPMSpider(scrapy.Spider):
    name = "cpm"
    start_urls = ["https://v8.1c.ru/cpm/"]
    ...
    def should_follow_link(link: str, base_url: str) -> bool:
        ...
        return "https://v8.1c.ru/cpm/" in absolute_url


def extract_clean_text(html: str) -> str:
    html = remove_all_scripts(html)
...
def remove_all_scripts(html: str) -> str:
